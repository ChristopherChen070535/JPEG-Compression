...
clean:
	rm -f encoder_411086013.exe decoder_411086013.exe R.txt G.txt B.txt dim.txt Qt_Y.txt Qt_Cb.txt Qt_Cr.txt qF_Y.raw qF_Cb.raw qF_Cr.raw eF_Y.raw eF_Cb.raw eF_Cr.raw QResKimberlyNCat.bmp ResKimberlyNCat.bmp ResKimberlyNCat1.bmp
